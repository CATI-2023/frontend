...
import { palestraIndex } from "../../../../Types/type";
import { useEffect, useState } from "react";
import { getPalestrasIndex } from "../../../../services/palestras";
...
export function ThirdSection() {
  const [palestras, setPalestras] = useState<palestraIndex[] | null>(null);
  async function getPalestras() {
    getPalestrasIndex().then((res) => {
      setPalestras(res.palestras);
    });
  }
      ...
      >
        ...
        <Grid container justifyContent={"center"} justifyItems={"center"}>
          {palestras?.map((p, idx) => (
            ...
            >
              <PalestranteCard
                atuacao={p.atuacao_palestrante}
                nome={p.palestrante?.nome || ""}
                tema={p.tema}
                foto={p.palestrante?.foto}
                lattes={p.lattes_palestrante}
                linkedin={""}
              />
            </Grid>
          ))}
