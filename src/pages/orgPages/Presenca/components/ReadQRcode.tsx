...
export function QrScannerComponent() {
    ...
    useEffect(() => {
        ...
        const scanner = new QrScanner(scannerVideo, result => onScanSuccess(result))
        scanner.start();
        return () => {
          scanner.stop();
        }
      ...
      const onScanSuccess = (result: string|null) => {
        ...
        //   console.log("Resultado do escaneamento:", result);
        }
      }   
    
    return(
        <video id="Scanner" width={"90%"} height={"auto"}></video>
    )
} 